...
echo color('blue', "[+]")." Vconomics Bot - Recode : joy\n";
echo color('blue', "[+]")." Input Reff: ";
$reff = trim(fgets(STDIN));

Start:
$domain = get_between_array(file_get_contents("https://temp-mail.org/id//"), 'onclick="change_dropdown_list(this.innerHTML)" id="', '" style="');
